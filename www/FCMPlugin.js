...
// GET OTTOKEN REFRESH CALLBACK //
FCMPlugin.prototype.onAnswerCall = function(success, error){
	exec(success, error, "FCMPlugin", 'onAnswerCall', []);
}
// FIRE READY //
...
exec(function(result){ localStorage.setItem('OTToken', result) }, function(result){ console.log("FCMPlugin onAnswerCall ERROR") }, "FCMPlugin",'onAnswerCall',[]);
