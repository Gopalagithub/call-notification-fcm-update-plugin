...
import com.gae.scaffolder.plugin.NotificationActionService;
...
public class FCMPlugin extends CordovaPlugin {
	...
	public static String onAnswerCallCallBack = "FCMPlugin.onAnswerCallCallBack";
	...
	public boolean execute(final String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
		...
		try{
			...
			else if (action.equals("onAnswerCall")) {
				//TODO Retrive Sharedprefference

				cordova.getActivity().runOnUiThread(new Runnable() {
					public void run() {
						try{
//
							String OTToken = FCMPlugin.onAnswerCall();
							callbackContext.success( "OTToken : "+OTToken );
						}catch(Exception e){
	...
	public static String onAnswerCall(){
		String sessionDetails="GopalTest";
		try {
			SharedPreferences prefs =  NotificationActionService.sp;
			String session_id = prefs.getString("session_id", null);
			String token = prefs.getString("token", null);
			sessionDetails=session_id+","+token;
		}catch (Exception e){
